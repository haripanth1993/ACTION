         ...
         <div class="col-md-12">
            <div class="card ">
               <div class="card-header card-header-rose card-header-icon">
                  ...
                  <h4 class="card-title text-capitalize">Get Existing counters for customer {{ $customerName }}</h4>
               </div>
               <div class="card-body">
                  <div class="text-right top-button-panel">
                     <a href="<?= url('customers'); ?>" class="btn btn-primary mr-0 ml-auto">
...
<!--End delete widget popup for counters by id-->	
