      ...
      <div class="col-md-12">
         <div class="card ">
            <div class="card-header card-header-rose card-header-icon">
               ...
               <h4 class="card-title">Get counter for project {{ $projectName }}</h4>
            </div>
            <div class="card-body ">
               <div class="text-right top-button-panel">
                  <a  href="<?= url('projects'); ?>/{{ $customerId }}"  class="btn btn-primary back">
                     Back to all projects 
                     <div class="ripple-container"></div>
                  </a>
               </div>
               <form method="post" action="<?= url('projects'); ?>/widgetspost" enctype='multipart/form-data'>
                  @csrf 
                  <div class="row">
                     <label class="col-md-3 col-form-label">Project ID: </label>
                     <div class="col-md-9">
                        <div class="form-group has-default">
                           <input type="text" name="buttoncode" value="{{ $projectid }}" class="pointer-none form-control"> 
                        </div>
                     </div>
                  </div>
                  <div class="row">
                     ...
                     <div class="col-md-9">
                        <div class="form-group">
                           <select class="selectpicker mw-100" name="point" data-style="select-with-transition" data-size="7">
							  ...
							  <option value="AverageDonation">Average Donation</option>
                           </select>
                        </div>
                     </div>
                  </div>
...
<script src="https://new-actionbutton.voxara.net/js/project-counter-widgets.js?{{$buttoncode}}{{ $point }}"></script>
</div>
<!-- end counter widget -->
</xmp>
                  </div>
            ...
            <div class="response-panel">
               ...
               <div class="sample-code  bg-light">
                  <div class="counter-widget">
                     ...
                     <p><?php echo $text; ?></p>
                     <?php } ?>
                     <script src="https://new-actionbutton.voxara.net/js/admin-project-counter-widgets.js?counterid{{ $point }}"></script>
                  </div>
               </div>
            </div>
         </div>
