         ...
         <div class="col-md-12">
            <div class="card ">
               <div class="card-header card-header-rose card-header-icon">
                  ...
                  <h4 class="card-title text-capitalize">Get Existing counters for button {{ $projects[0]->button_name }}</h4>
               </div>
               <div class="card-body">
                  <div class="text-right top-button-panel">
                     <a  href="<?= url('buttons'); ?>/{{ $projects[0]->project_id }}" class="btn btn-primary mr-0 ml-auto">
                        Back to button
...
<!-- Start Delete popup for counters by id-->
<script>
...
<!--End Delete popup for counters by id-->	
<!-- Start Copy counter-->
<script>
