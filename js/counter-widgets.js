...
$.getJSON("https://new-actionbutton.voxara.net/public/index.php/buttons/widgets/data/"+ButtonCode+"?callback=?&datapoints="+datapoint+"&buttonId="+buttonId+"&CustomerUrl="+siteUrl, function(result){
