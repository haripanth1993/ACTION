...
$.getJSON("https://new-actionbutton.voxara.net/public/index.php/customer/widgets/data/"+ButtonCode+"?callback=?&datapoints="+datapoint+"&buttonId="+buttonId+"&CustomerUrl="+siteUrl, function(result){
